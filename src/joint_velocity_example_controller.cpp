// This file is copied and modified from the franka_ros's franka_example_controllers package
...
bool JointVelocityExampleController::init(hardware_interface::RobotHW* robot_hardware,
  ...
  for (size_t i = 0; i < q_start.size(); i++) {
    if (std::abs(velocity_joint_handles_[i].getPosition() - q_start[i]) > 0.05) {
      ROS_ERROR_STREAM(
...
PLUGINLIB_EXPORT_CLASS(fliqc_controller_ros::JointVelocityExampleController,
